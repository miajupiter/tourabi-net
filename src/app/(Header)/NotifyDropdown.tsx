...
const NotifyDropdown: FC<Props> = ({ className = "" }) => {
  ...
  const [notifications, setNotifications] = useState([{
    name: 'TourAbi',
    description: t('Welcome to TourAbi.net. TourAbi is the world\'s best digital tourism portal.'),
    time: '1 minute ago',
    href: '/tours',
    avatar: '/img/web-icon.png'
  }])
                  ...
                  <div className="relative grid gap-8 bg-white dark:bg-neutral-800 p-7 text-left">
                    ...
                    {notifications.map((item, index) => (
                      ...
                      >
                        ...
                        /> */}
                        <img src={item.avatar} className='rounded-full w-12 h-12' alt="tourabi" />
