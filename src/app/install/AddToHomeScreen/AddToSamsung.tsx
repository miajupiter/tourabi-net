...
import { TableCellsIcon, PlusIcon, SquaresPlusIcon, ArrowDownIcon, ClockIcon } from '@heroicons/react/24/outline'
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 h-[80%] z-50 pb-12 px-4 text-white">
            <div className="relative bg-primary p-4 h-full rounded-xl flex flex-col justify-around items-center text-center">
                ...
                <ArrowDownIcon className="text-lg absolute -bottom-[50px] right-[-3px] text-indigo-700 z-10 animate-bounce" />
            </div>
